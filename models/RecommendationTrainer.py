...
class RecommendationTrainer:
    ...
    def getCosinSimilarityForGenres(self):
        ...
        self.gamesDF["genres_parsed"] = self.gamesDF["genres_normalized"].apply(parse_genres)
    ...
    def getCosinSimilarityForSummary(self):
        ...
        tfidf_matrix = tfidf.fit_transform(self.gamesDF['summary'].fillna('').values.astype('U'))
        cosine_sim = cosine_similarity(tfidf_matrix)
        return pd.DataFrame(cosine_sim)
